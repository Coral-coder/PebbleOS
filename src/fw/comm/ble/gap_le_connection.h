...
typedef struct GAPLEConnection {
  ...
  struct {
    ...
    //! Interval class (ResponseTimeState) this connection currently contributes
    //! to the global ble_conn_itvl_* analytics timers; ResponseTimeInvalid when
    //! it contributes to none.
